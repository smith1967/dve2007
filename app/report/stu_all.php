...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                รายงานข้อมูลจำนวนนักเรียน ระบบทวิภาคี 
                <small>จำแนกตามสาขาวิชา ในจังหวัด</small>
            </h1>
        </section>
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">รายงานข้อมูลนักเรียน จำแนกตามสาขาวิชา ในจังหวัด </h3>              
                </div>
                <!--box-header-->
                <div class="box-body">
    ...
    <tr align=center >
        ...
        <th rowspan="3" width="30px">สาขาวิชา</th>
        <th rowspan="3" width="30px">จังหวัด</th>
    ...
    <tr align=center>
     ...
     $sql = "SELECT  sch.school_name, ma.major_name,
MIN(p.province_name) as province_name,
...
JOIN major ma ON ma.major_id=s.major_id
