                    ...
                    <div class="box box-info">
                        ...
                        <form method="post" class="form-horizontal" action="">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="business_name" class="col-md-2 control-label">ชื่อการทำความร่วมมือ</label>
                                    <div class="col-md-4">
                                ...
                                ?>
                                <div class="form-group">
                                    <label for="business_size" class="col-md-2 control-label">ขนาดการทำความร่วมมือ</label>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-offset-1">ที่ตั้งการทำความร่วมมือ</label>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="tax_break" class="control-label col-md-offset-1"><u>คำชี้แจง</u>กรุณาคลิกในช่องที่ตรงกับคุณลักษณะของการทำความร่วมมือ</label>
                                    <?php
                                ...
                                <div class="form-group">
                                    <label for="benefit" class="control-label col-md-offset-1"><u>คำชี้แจง</u>กรุณาคลิกในช่องที่ตรงกับสวัสดิการของการทำความร่วมมือ</label>
...
//    }
    if (empty($data['business_name'])) {
        set_err('กรุณากรอกชื่อการทำความร่วมมือ');
        $valid = false;
    }
